...
const { getDateRange, getWeekendDays, getCalendarHolidays } = require("../../utils/CalendarCommon")
...
class ReportController {
  ...
  async generate(req, res) {
    ...
    try {
      ...
      let listLiburKalender = await getCalendarHolidays(start_date, end_date)
          ...
          for(let tgl of listRangeTanggal){
            ...
            if (isSabtuMinggu || isLiburKalender) {
              ...
              if(rPresence){
                ...
                let eCO = moment(rPresence.check_out).format('HH:mm:ss')
